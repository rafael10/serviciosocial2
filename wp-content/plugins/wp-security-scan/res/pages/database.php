...
<div class="wrap wsdplugin_content">
    <h2><?php echo WPS_PLUGIN_NAME.' - '. __('Database Tools');?></h2>
    ...
    <div style="clear: both; display: block;">
        ...
        <div class="metabox-holder" style="overflow: hidden;">
            ...
            <div id="bckdb" style="float:left; width:49%;" class="inner-sidebar1 postbox">
                ...
                <div class="inside">
                    <?php echo WsdUtil::loadTemplate('box-database-backup'); ?>
                </div>
            </div>
            ...
            <div style="float:right;width:49%;" class="inner-sidebar1 postbox">
                ...
                <div class="inside" id="box-available-backups">
                    <?php echo WsdUtil::loadTemplate('box-available-backups'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="metabox-holder" style="width:99.8%; padding-top: 0;">
            ...
            <div id="cdtp" class="postbox">
                ...
                <div class="inside">
                    <?php echo WsdUtil::loadTemplate('box-database-change-prefix'); ?>
                </div>
            </div>
        </div>
